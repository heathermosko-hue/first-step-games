...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($email) {
        ...
        $welcome_body .= "🎮  2 Weeks of FREE Hub Access — No Credit Card Needed!\n";
        $welcome_body .= "     $greeting now has full access to all of our interactive reading games\n";
        $welcome_body .= "     in the First Step Reading Hub — completely free for 14 days.\n";
        $welcome_body .= "     Just visit the link below and your trial activates automatically!\n\n";
        $welcome_body .= "─────────────────────────────────────\n";
